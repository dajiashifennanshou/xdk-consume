...
public class PersonDossierController {
	...
	public Object getInfo(@RequestParam String clientid,@RequestParam String cardid,@RequestParam Double spendMoney,@RequestParam String computer,@RequestParam String spenddate,@RequestParam String spendtime,@RequestParam String windowNumber) {
